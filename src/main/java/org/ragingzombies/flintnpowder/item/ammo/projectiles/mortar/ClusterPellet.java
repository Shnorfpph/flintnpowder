...
public class ClusterPellet extends AbstractArrow implements ItemSupplier {

    public float damage = 1;

    public ClusterPellet(EntityType<? extends AbstractArrow> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }
    public ClusterPellet(Level pLevel) {
        super(ModProjectiles.CASTIRONROUNDSHOTPROJECTILE.get(), pLevel);
    }
    public ClusterPellet(Level pLevel, LivingEntity livingEntity) {
    ...
    void impact(BlockPos pos) {
        ...
        this.level().explode(this, null, null, getX(), getY(), getZ(), 4.25f, false, Level.ExplosionInteraction.NONE);
        this.discard();
    }
