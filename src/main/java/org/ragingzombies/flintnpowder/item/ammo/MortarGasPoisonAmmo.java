...
public class MortarGasPoisonAmmo extends BaseAmmo {
    public MortarGasPoisonAmmo(Properties pProperties) {
        super(pProperties);
    ...
    public void onAmmoShot(float xRotation, float yRotation, LivingEntity shooter, ItemStack gun, Level level) {
        PoisonGasProjectile proj = new PoisonGasProjectile(level, shooter);
