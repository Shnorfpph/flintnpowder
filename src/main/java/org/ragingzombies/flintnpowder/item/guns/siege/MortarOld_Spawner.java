...
public class MortarOld_Spawner extends Item {
    public MortarOld_Spawner(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        if (!pLevel.isClientSide()) {
            ...
            if (hitResult.getType() == HitResult.Type.BLOCK) {
                ...
                OldMortarEntity ent = new OldMortarEntity(ModEntities.OLDMORTAR.get(), pLevel);
