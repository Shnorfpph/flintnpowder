...
public class ClusterShell extends BaseAmmo {
    public ClusterShell(Properties pProperties) {
        super(pProperties);
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("item.flintnpowder.clustershell.description_0"));
