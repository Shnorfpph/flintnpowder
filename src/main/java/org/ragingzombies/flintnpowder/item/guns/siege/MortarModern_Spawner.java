...
public class MortarModern_Spawner extends Item {
    public MortarModern_Spawner(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        if (!pLevel.isClientSide()) {
            ...
            if (hitResult.getType() == HitResult.Type.BLOCK) {
                ...
                MortarEntity ent = new MortarEntity(ModEntities.MORTAR.get(), pLevel);
