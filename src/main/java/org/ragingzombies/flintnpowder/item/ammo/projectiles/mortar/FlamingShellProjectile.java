...
public class FlamingShellProjectile extends AbstractArrow implements ItemSupplier {

    MortarFallingSoundInstance snd = null;
    public FlamingShellProjectile(EntityType<? extends AbstractArrow> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }
    public FlamingShellProjectile(Level pLevel) {
        super(ModProjectiles.HESHELL.get(), pLevel);
    }
    public FlamingShellProjectile(Level pLevel, LivingEntity livingEntity) {
    ...
    void impact(BlockPos pos) {
        ...
        this.level().explode(this, null, null, getX(), getY(), getZ(), 2f, false, Level.ExplosionInteraction.BLOCK);
        this.level().explode(this, null, null, getX(), getY(), getZ(), 8f, true, Level.ExplosionInteraction.NONE);
        this.discard();
    }
