...
public class TheRockProjectile extends AbstractArrow implements ItemSupplier {

    public float damage = 1;

    public TheRockProjectile(EntityType<? extends AbstractArrow> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }
    public TheRockProjectile(Level pLevel) {
        super(ModProjectiles.CASTIRONROUNDSHOTPROJECTILE.get(), pLevel);
    }
    public TheRockProjectile(Level pLevel, LivingEntity livingEntity) {
