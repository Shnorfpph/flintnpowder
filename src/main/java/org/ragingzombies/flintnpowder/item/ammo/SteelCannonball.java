...
import org.ragingzombies.flintnpowder.item.ammo.projectiles.SteelCannonballProjectile;

public class SteelCannonball extends BaseAmmo {
    public SteelCannonball(Properties pProperties) {
        super(pProperties);
